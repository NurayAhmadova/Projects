...
driver = webdriver.Firefox(executable_path="/Users/nurayahmadova/SeleniumWebDriver/geckodriver")
driver.get("https://www.linkedin.com/jobs/search/?geoId=103644278&keywords=intern&location=United%20States")
sleep(1)
...
username.send_keys("python.test.n.a@gmail.com")
password = driver.find_element_by_id('password')
password.send_keys("PYTHON123")
